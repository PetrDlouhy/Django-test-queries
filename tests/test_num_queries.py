...
class TestNumQueriesMixin(NumQueriesMixin, TestCase):
    ...
    def test_file_comparison_with_existing_lines_not_equal(self):
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertEquals(mock_print.call_args_list[3], call(f'  diff {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_not_equal.0.sqllog {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_not_equal.0.sqllog.new'))
            self.assertEquals(len(mock_print.call_args_list), 4)

    def test_file_comparison_with_existing_lines_delete(self):
        expected_filename = 'tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_delete.0.sqllog'
        with open(expected_filename, 'w') as f:
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertEquals(mock_print.call_args_list[2], call('See difference:'))
            self.assertEquals(mock_print.call_args_list[3], call(f'  diff {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_delete.0.sqllog {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_delete.0.sqllog.new'))
            self.assertEquals(mock_print.call_args_list[4], call("delete    a[2:3] --> b[3:3] ['SELECT 3...'] --> []"))
            self.assertEquals(len(mock_print.call_args_list), 5)

    def test_file_comparison_with_existing_lines_replace(self):
        expected_filename = 'tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_replace.0.sqllog'
        with open(expected_filename, 'w') as f:
        ...
        with patch('builtins.print') as mock_print:
            ...
            self.assertEquals(mock_print.call_args_list[2], call('See difference:'))
            self.assertEquals(mock_print.call_args_list[3], call(f'  diff {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_replace.0.sqllog {current_directory}/tests/sqllog/test_num_queries.TestNumQueriesMixin.test_file_comparison_with_existing_lines_replace.0.sqllog.new'))
            self.assertEquals(len(mock_print.call_args_list), 4)
